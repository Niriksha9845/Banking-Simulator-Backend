...
public class AccountTest {
	...
	public static void main(String[] args) {
		...
		try {
			Account acc1 = service.createAccount("navya", "navyan@gmail.com", new BigDecimal("2000"));
			Account acc2 = service.createAccount("Radha", "radha@gmail.com", new BigDecimal("5000"));
			
			Account acc3 = service.createAccount("navya", "navyan@gmail.com", new BigDecimal("2000"));
