...
public class AlertTest {
	public static void main(String[] args) {
		...
		/*try {
			Account account = accountService.createAccount("navya", "navyan1809@gmail.com", new BigDecimal("500"));
		...
		try {
			Account account = accountService.createAccount("navya", "navyan1809@gmail.com", new BigDecimal("5000"));
